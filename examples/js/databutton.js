var databutton = {
  ...
  build: function(o) {
    if (o.file) {
      var buttonEl =
        o.button.$el instanceof Element
          ? o.button.$el
          : document.querySelector(o.button.$el);
      var fileEl =
        o.file.$el instanceof Element
          ? o.file.$el
          : document.querySelector(o.file.$el);
      fileEl.onchange = function(e) {
        console.log("no file type here?", e.target.files[0]);
        ...
        reader.addEventListener("load", function(event) {
          ...
          datapay.build({ data: d }, function(err, tx) {
            ...
            relayone.render(buttonEl, o.button);
          });
        });
